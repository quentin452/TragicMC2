...
public class WorldGenDimensionLakes extends WorldGenerator {
    ...
    private final Block theBlock = Blocks.lava;
        ...
        if (p_76484_4_ <= 4) {
            ...
            for (i1 = 0; i1 < 16; ++i1) {
                for (j2 = 0; j2 < 16; ++j2) {
                    for (j1 = 0; j1 < 8; ++j1) {
                        ...
                        if (flag) {
                            Material material = p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2)
                                .getMaterial();
                            ...
                            if (j1 < 4 && !material.isSolid()
                                && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2)
                                    != this.theBlock) {
                                return false;
                            }
                        }
            ...
            for (i1 = 0; i1 < 16; ++i1) {
                for (j2 = 0; j2 < 16; ++j2) {
                    for (j1 = 4; j1 < 8; ++j1) {
                        if (aboolean[(i1 * 16 + j2) * 8 + j1]
                            && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1 - 1, p_76484_5_ + j2) == Blocks.dirt
                            && p_76484_1_
                                .getSavedLightValue(EnumSkyBlock.Sky, p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2)
                                > 0) {
                            BiomeGenBase biomegenbase = p_76484_1_
                                .getBiomeGenForCoords(p_76484_3_ + i1, p_76484_5_ + j2);
            ...
            for (i1 = 0; i1 < 16; ++i1) {
                for (j2 = 0; j2 < 16; ++j2) {
                    for (j1 = 0; j1 < 8; ++j1) {
                        ...
                        if (flag && (j1 < 4 || p_76484_2_.nextInt(2) != 0)
                            && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2)
                                .getMaterial()
                                .isSolid()) {
                            p_76484_1_.setBlock(
