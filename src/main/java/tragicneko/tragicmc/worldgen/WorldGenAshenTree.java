...
public class WorldGenAshenTree extends WorldGenAbstractTree {

    public WorldGenAshenTree(boolean p_i45463_1_) {
        super(p_i45463_1_);
    }
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
            ...
            if (!flag) {
                ...
                boolean isSoil = block3.canSustainPlant(
                    p_76484_1_,
                    p_76484_3_,
                    p_76484_4_ - 1,
                    p_76484_5_,
                ...
                if (isSoil && p_76484_4_ < 256 - l - 1) {
                    ...
                    for (j2 = 0; j2 < l; ++j2) {
                        ...
                        if (block1.isAir(p_76484_1_, k3, k2, l1) || block1.isLeaves(p_76484_1_, k3, k2, l1)) {
                            this.setBlockAndNotifyAdequately(p_76484_1_, k3, k2, l1, TragicBlocks.AshenWood, 0);
                            i2 = k2;
                        }
                    }
                        ...
                        for (l2 = k2; l2 < l && l3 > 0; --l3) {
                            if (l2 >= 1) {
                                ...
                                if (block2.isAir(p_76484_1_, k3, i3, l1) || block2.isLeaves(p_76484_1_, k3, i3, l1)) {
                                    this.setBlockAndNotifyAdequately(p_76484_1_, k3, i3, l1, TragicBlocks.AshenWood, 0);
                                    i2 = i3;
                                }
                            }
    ...
    private void func_150525_a(World p_150525_1_, int p_150525_2_, int p_150525_3_, int p_150525_4_) {
        ...
        if (block.isAir(p_150525_1_, p_150525_2_, p_150525_3_, p_150525_4_)
            || block.isLeaves(p_150525_1_, p_150525_2_, p_150525_3_, p_150525_4_)) {
            this.setBlockAndNotifyAdequately(
                p_150525_1_,
                p_150525_2_,
                p_150525_3_,
                p_150525_4_,
                TragicBlocks.AshenLeaves,
                0);
        }
    }
}
