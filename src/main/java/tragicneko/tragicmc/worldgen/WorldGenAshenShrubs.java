...
public class WorldGenAshenShrubs extends WorldGenTrees {

    public WorldGenAshenShrubs() {
        super(false);
    }
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        ...
        if (block1.canSustainPlant(
            ...
            ++p_76484_4_;
            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_, p_76484_5_, TragicBlocks.AshenWood, 0);
                ...
                for (int k1 = p_76484_3_ - j1; k1 <= p_76484_3_ + j1; ++k1) {
                    ...
                    for (int i2 = p_76484_5_ - j1; i2 <= p_76484_5_ + j1; ++i2) {
                        ...
                        if ((Math.abs(l1) != j1 || Math.abs(j2) != j1 || p_76484_2_.nextInt(2) != 0)
                            && p_76484_1_.getBlock(k1, l, i2)
                                .canBeReplacedByLeaves(p_76484_1_, k1, l, i2)) {
                            this.setBlockAndNotifyAdequately(p_76484_1_, k1, l, i2, TragicBlocks.AshenLeaves, 0);
                        }
                    }
                }
            }
