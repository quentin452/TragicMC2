...
public class SynapseChunkProvider implements IChunkProvider {
    ...
    public void replaceBiomeBlocks(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_, byte[] meta,
        ...
        this.slowsandNoise = this.slowsandGravelNoiseGen
            .generateNoiseOctaves(this.slowsandNoise, p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, d0, d0, 1.0D);
        this.gravelNoise = this.slowsandGravelNoiseGen
            .generateNoiseOctaves(this.gravelNoise, p_147418_1_ * 16, 109, p_147418_2_ * 16, 16, 1, 16, d0, 1.0D, d0);
        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                int i1 = (int) (this.netherrackExclusivityNoise[k + l * 16] / 3.0D + 3.0D
                    + this.synapseRNG.nextDouble() * 0.25D);
                int j1 = -1;
                ...
                for (int k1 = 127; k1 >= 0; --k1) {
                    ...
                    if (k1 < 96 - this.synapseRNG.nextInt(4) && k1 > 24 + this.synapseRNG.nextInt(4)) {
                        ...
                        p_147418_3_[l1] = this.synapseRNG.nextInt(16) != 0 || !TragicConfig.allowDigitalSeaGen
                            ? Blocks.air
                            : TragicBlocks.DigitalSea;
                    }
                }
            }
        }
    ...
    public Chunk provideChunk(int p_73154_1_, int p_73154_2_) {
        ...
        BiomeGenBase[] abiomegenbase = this.worldObj.getWorldChunkManager()
            .loadBlockGeneratorData((BiomeGenBase[]) null, p_73154_1_ * 16, p_73154_2_ * 16, 16, 16); // Forge Move up
                                                                                                      // to allow for
                                                                                                      // passing to
                                                                                                      // replaceBiomeBlocks
    ...
    public void populate(IChunkProvider p_73153_1_, int x, int z) {
        ...
        if (TragicConfig.allowSynapseVariants && this.synapseRNG.nextInt(TragicConfig.synapseVariantChance) == 0)
            this.circuitVarGen.generate(this.synapseRNG, x, z, this.worldObj);
