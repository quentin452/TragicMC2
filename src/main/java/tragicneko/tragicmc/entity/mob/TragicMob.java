...
public abstract class TragicMob extends EntityMob {
    ...
    public void onLivingUpdate() {
        ...
        if (!TragicConfig.allowMobInfighting && this.getAttackTarget() != null
        ...
        if (this.getAttackTarget() == null && this.canCorrupt()
            ...
            && this.isPotionActive(TragicPotion.Corruption.id)) {
        ...
        if (TragicConfig.allowCorruption) {
            ...
            if (this.canChange() && this.getCorruptionTicks() >= 400
                && this.rand.nextInt(200) <= TragicConfig.mobTransformationChance
                && this.ticksExisted % 20 == 0
                && rand.nextInt(4) == 0) {
                this.dataWatcher.updateObject(14, (byte) 1);
            }
        } else if (this.canChange() && this.ticksExisted >= 6000
            && this.ticksExisted % 20 == 0
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        ...
        if (result && TragicConfig.allowCorruption
            && this.canCorrupt()
            && rand.nextInt(4) == 0
            && this.isPotionActive(TragicPotion.Corruption)) {
            ...
            if (id != 0 && rand.nextInt(100) <= TragicConfig.mobStatueDropChance && flag) {
                this.capturedDrops.add(
                    new EntityItem(
                        ...
                        this.posY,
                        this.posZ,
                        new ItemStack(TragicItems.MobStatue, 1, id)));
            }
        }
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
        if (!this.worldObj.isRemote && this.worldObj.difficultySetting == EnumDifficulty.HARD
            && TragicConfig.allowRandomSupportMob) this.setSupport(rand.nextInt(100) == 0);
